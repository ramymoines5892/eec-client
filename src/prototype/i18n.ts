...
const en: Dict = {
  ...
  "auth.verifySent.body": "We just sent a verification link to your email. Open it to continue setting up your account.",
  ...
  "toast.emailSent": "Verification link sent. Please check your inbox.",
...
const ar: Dict = {
  ...
  "auth.verifySent.body": "أرسلنا رابط تحقق إلى بريدك. افتح الرابط لمتابعة إعداد حسابك.",
  ...
  "toast.emailSent": "تم إرسال رابط التحقق. يرجى مراجعة صندوق الوارد.",
