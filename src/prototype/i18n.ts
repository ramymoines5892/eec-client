...
const en: Dict = {
  ...
  "admin.num.module": "Module",
  "admin.num.docType": "Doc Type",
  "admin.num.prefix": "Prefix",
  "admin.num.suffix": "Suffix",
  "admin.num.padding": "Padding",
  "admin.num.next": "Next Value",
  "admin.num.reset": "Reset",
  "admin.num.reset.never": "Never",
  "admin.num.reset.yearly": "Yearly",
  "admin.num.reset.monthly": "Monthly",
  "admin.num.preview": "Preview",
  "admin.num.err.module": "Module is required",
  "admin.num.err.docType": "Doc type is required",
  "admin.wf.steps": "Steps",
  "admin.wf.stepsHint": "Ordered approval steps. Each step can require a role and a minimum number of approvers.",
  "admin.wf.manageSteps": "Manage steps",
  "admin.wf.stepNo": "Step No.",
  "admin.wf.role": "Role Required",
  "admin.wf.minApprovers": "Min Approvers",
  "admin.wf.optional": "Optional",
  "admin.wf.err.stepNo": "Step number is required",
  "admin.sec.noUsers": "No users found.",
...
const ar: Dict = {
  ...
  "admin.num.module": "الوحدة",
  "admin.num.docType": "نوع المستند",
  "admin.num.prefix": "بادئة",
  "admin.num.suffix": "لاحقة",
  "admin.num.padding": "طول الرقم",
  "admin.num.next": "القيمة التالية",
  "admin.num.reset": "إعادة التعيين",
  "admin.num.reset.never": "أبدًا",
  "admin.num.reset.yearly": "سنويًا",
  "admin.num.reset.monthly": "شهريًا",
  "admin.num.preview": "معاينة",
  "admin.num.err.module": "الوحدة مطلوبة",
  "admin.num.err.docType": "نوع المستند مطلوب",
  "admin.wf.steps": "الخطوات",
  "admin.wf.stepsHint": "خطوات الاعتماد بترتيبها. كل خطوة يمكن أن تتطلب دورًا وعددًا أدنى من المعتمدين.",
  "admin.wf.manageSteps": "إدارة الخطوات",
  "admin.wf.stepNo": "رقم الخطوة",
  "admin.wf.role": "الدور المطلوب",
  "admin.wf.minApprovers": "الحد الأدنى للمعتمدين",
  "admin.wf.optional": "اختيارية",
  "admin.wf.err.stepNo": "رقم الخطوة مطلوب",
  "admin.sec.noUsers": "لا يوجد مستخدمون.",
